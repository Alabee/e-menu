    ...
    <nav class="navbar navbar-default nav-sticky">
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="#" class="navbar-brand">eMenu</a>
            </div><!--navbar-header-->
...
<!--    @yield('content')-->
    <div class="container-fluid home-area" data-aos="fade-up">
        <video autoplay muted loop id="myVideo">
            <source src="media/service_hotel.mp4" type="video/mp4">
        ...
        <div class="row">
            <div class="col-md-6 intro">
                <h1>eMenu</h1>
                <p>
                    Our Hotel has recently gone digital. We want to give you the best services yet the easiest way and the tastiest meals ever.
                    Order you delicious meal now and we shall deliver it to you.
                </p>
                <div class="intro-btns">
                    <a href="menu.html" class="btn btn-primary btn-intro"><span>MENU</span></a>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <ul class="about-connect">
                        ...
                        <li><i class="fa fa-envelope"></i>support@ourhotel.co.ke</li>
                        <li><i class="fa fa-phone"></i>0712003061</li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <h4>Social Media</h4>
                ...
                <div class="col-md-4">
                    ...
                    <ul class="quick-links">
                        ...
                        <li><a href="#projects" class="js-scroll-trigger">Hotels</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="container text-center copyright">
            <small>&copy; eMenu, 2018. All Rights Reserved.</small>
        </div>
    </footer>
</div><!-- #app -->
